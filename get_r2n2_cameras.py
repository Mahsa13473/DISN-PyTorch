...
# python get_r2n2_cameras.py meta.txt /local-scratch/mma/DISN/version1/camera_test.npz
...
def main(args):
    ...
    for idx in range(data.shape[0]):
        ...
        #rotation and translation matrices (RT world2cam) (3x4) R:3x3 T:3x1
...
if __name__ == '__main__':
    folder = '/local-scratch/mma/DISN/version1'
    ...
    camera_file = os.path.join(folder, 'camera_test.npz')
